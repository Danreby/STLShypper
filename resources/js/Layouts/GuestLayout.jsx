            ...
            <div className="flex flex-1 flex-col items-center justify-center px-4 py-10 sm:px-6 lg:w-1/2">
                <div className="mb-8 lg:hidden">
                    <Link href="/" className="flex items-center gap-3">
                        <span className="flex h-11 w-11 items-center justify-center rounded-2xl bg-linear-to-br from-brand-500 via-violet-500 to-accent-400 shadow-lg shadow-brand-500/30">
                            <ApplicationLogo className="h-6 w-6 fill-current text-white" />
                        </span>
